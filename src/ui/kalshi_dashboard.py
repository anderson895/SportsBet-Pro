...
class KalshiDashboard(QWidget):
    ...
    def __init__(
        self, db: ScopedDatabase,
        exchange_key: str = "kalshi",
        exchange_label: str = "Kalshi",
        exchange_icon: str = "fa6s.chart-column",
        ...
        self.cards = {
            ...
            exchange_key: StatusCard(exchange_icon, exchange_label,
                                     exchange_color),
        }
    ...
    def refresh_balance(self) -> None:
        ...
        start = float(self._db.get_setting(self._paper_start_key,
                                           DEFAULT_PAPER_START))
        open_cost = 0.0
        import json
        ...
        self.balance_card.set_value(f"{balance:,.2f} {self._currency}", color)
    ...
    def set_mode(self, mode: str) -> None:
        ...
        if self._live_mode:
            ...
            self.balance_card.set_sub(
                f"Real {self._currency} on {self._exchange_label}")
    ...
    def set_live_balance(self, balance: float) -> None:
        self.balance_card.set_value(
            f"{balance:,.2f} {self._currency}", theme.ACCENT)
